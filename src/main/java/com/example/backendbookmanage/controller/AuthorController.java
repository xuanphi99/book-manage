...
public class AuthorController {
    ...
    @GetMapping(path = Constants.PathMapping.API_AUTHOR)
    public ResponseEntity<GeneralResponseCustom< List<AuthorEnity> > > getAllAuthor(){
    	List<AuthorEnity> authorEntities = authorService.getAllAuthor();
        return factoryCustom.success(authorEntities);
